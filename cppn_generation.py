        ...
        for xi in range(position_information["xrange"]):
            ...
            for yi in range(position_information["yrange"]):
                ...
                for zi in range(position_information["zrange"]):
                    ...
                    block = is_there_a_block(genome, config, corner, args, block_options, x, y, z, xi, yi, zi)
...
def is_there_a_block(genome, config, corner, args, block_options, x, y, z, xi, yi, zi):
...
#def query_cppn_for_snake_shape():